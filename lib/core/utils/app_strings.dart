class AppStrings {
  ...
  static const String salesAgentIntroText =
      """منصة فلك هي بوابتك الذكية لعالم المزادات! نقدم لك حلولاً مبتكرة واحترافية لإدارة وتسويق المزادات بكل أنواعها — بسهولة، مرونة، وكفاءة عالية. تواصل معنا الآن وابدأ رحلتك مع الأفضل في تنظيم المزادات.""";
}
